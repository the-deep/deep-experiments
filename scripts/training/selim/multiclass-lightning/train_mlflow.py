...
if __name__ == "__main__":
    ...
    all_dataset = read_merge_data (args.training_dir,
                                    args.val_dir, 
                                    training_column=args.training_column,
                                    data_format='pickle')
    ...
    with mlflow.start_run():
        ...
        model_subpillars = train_on_specific_targets(train_df,
                                                    val_df,
                                                    FILENAME,
                                                    args.model_name,
                                                    args.tokenizer_name,
        ...
        mlflow.pyfunc.log_model(
            ...
            code_path=[__file__, "classes.py", "utils.py", "inference.py"],  # file dependencies
        )

        start = timeit.default_timer()
        metrics_pillars, metrics_subpillars, ratio_evaluated_sentences = model_subpillars.custom_eval(val_df)
