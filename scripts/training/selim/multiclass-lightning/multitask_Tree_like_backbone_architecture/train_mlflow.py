    ...
    with mlflow.start_run():
        ...
        for column in training_columns:
            ...
            while best_score < 0.7 and iter_nb < args.nb_repetitions:
                ...
                if column == 'all_present_level_1_prim_tags':
                    backbone_model = None
                else:
                    backbone_model = raw_models['all_present_level_1_prim_tags']

                """if column == 'all_present_level_1_prim_tags':
                    backbone_model = None
                elif column == 'present_prim_tags':
                    backbone_model = raw_models['all_present_level_1_prim_tags']
                elif column in ['sectors', 'pillars_1d', 'pillars_2d']:
                    backbone_model = raw_models['present_prim_tags']
                elif 'subpillars_1d' in column:
                    backbone_model = raw_models['pillars_1d']
                elif 'subpillars_2d' in column:
                    backbone_model = raw_models['pillars_2d']
                else:
                    raise Exception("probelm with backbone assignement!") """
                ...
                if model_score > best_score:
                    ...
                    raw_models[column] = model.model_architecture
                    if column != 'all_present_level_1_prim_tags':
