...
from architecture import InitialModel, NextModels
...
class Transformer(pl.LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        if backbone_model is None:
            self.model_architecture = InitialModel(
                model_name_or_path=model_name_or_path,
                ids_each_level=self.ids_each_level,
            ...
            self.model_architecture = NextModels(
    ...
    def forward(self, inputs):
        output = self.model_architecture(inputs)
        return output
