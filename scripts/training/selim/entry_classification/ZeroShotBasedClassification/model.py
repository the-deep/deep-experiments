...
from utils import flatten, tagname_to_id, compute_weights, beta_score, get_hypotheses
...
class Transformer(pl.LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        unique_labels = list(self.tagname_to_tagid.keys())
        self.hypotheses = get_hypotheses(unique_labels)
    ...
    def get_loaders(
        ...
        data_set = CustomDataset(
            dataset, tagname_to_tagid, tokenizer, hypotheses, max_len
        )
        loader = DataLoader(data_set, **params, pin_memory=True)
        return loader
