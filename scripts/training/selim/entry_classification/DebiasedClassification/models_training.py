...
def train_model(
    ...
    train_dataset = _initialize_counterfactual_dataset(
        _get_genders_countries(train_dataset)
    )
    val_dataset = _initialize_counterfactual_dataset(
        _get_genders_countries(val_dataset)
    )
