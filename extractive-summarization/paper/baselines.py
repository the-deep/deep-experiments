...
train_df = pd.read_csv("paper_datasets/v0.2/train_paper_v0.2.csv")
valid_df = pd.read_csv("paper_datasets/v0.2/val_paper_v0.2.csv")
test_df = pd.read_csv("paper_datasets/v0.2/test_paper_v0.2.csv")

df = pd.concat([train_df, valid_df, test_df])

texts = {}

for path_str in tqdm(glob.glob("paper_datasets/json/*.json")):
    path = Path(path_str)
